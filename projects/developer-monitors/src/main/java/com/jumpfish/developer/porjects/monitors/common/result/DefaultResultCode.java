...
public enum DefaultResultCode implements ResultCode {
    ...
    FEIGN_REMOTE_CALL_FAILED(100023, "Feign远程调用失败"),
    BATCH_UPDATE_EXCEPTION(100024,"批量更新异常"),
    ILLEGAL_ACCESS_EXCEPTION(100025,"非法访问异常"),
    INVALID_LOGIN_USER(100026, "用户账号或密码错误"),
    INVALID_USER_PASSWORD(100027, "密码错误"),
    INVALID_USER_NAME(100028, "用户账号错误"),
    INTERNAL_SERVER_ERROR(500, "服务器遇到错误，无法完成请求"),
    BADE_GATEWAY(502, "无法通过网关访问内部接口"),
